 <template>
  <section class="msite">
    ...
    <!--首页附近商家-->
    <div class="msite_shop_list" v-if="categorys.length">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    mounted(){
      this.$store.dispatch('getCategorys')  //发请求，出发action、发、、、
      this.$store.dispatch('getShops')  //发请求，出发action、
